      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-8">
        ...
        <div className="lg:col-span-7">
          <div className="h-full rounded-2xl border border-[rgba(245,243,238,0.1)] bg-[rgba(18,22,31,0.6)] p-6 sm:p-8 backdrop-blur-md flex flex-col justify-between">
            <div>
              ...
              <div className="border-t border-[rgba(245,243,238,0.08)] pt-4 space-y-2">
        ...
        <div className="lg:col-span-5">
          <div className="h-full rounded-2xl border border-[rgba(245,243,238,0.1)] bg-[rgba(18,22,31,0.6)] p-6 sm:p-8 backdrop-blur-md flex flex-col justify-between">
            <div>
              ...
              <div className="space-y-4">
                {Array.from({ length: 3 }).map((_, i) => (
                  <div
                    key={i}
                    className="rounded-xl border border-[rgba(245,243,238,0.08)] bg-[rgba(245,243,238,0.02)] p-4"
                  >
            ...
            <div className="mt-6 pt-4 border-t border-[rgba(245,243,238,0.08)]">
